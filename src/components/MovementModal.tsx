                  ...
                  <div className="flex flex-col gap-2 col-span-3">
                    ...
                    <div className="flex gap-1 items-center">
                      ...
                      <div
                        ...
                        style={{ opacity: !selectedProduct ? ".6" : "1" }}
                      >
                        ...
                        <div className="flex flex-col">
                          <div
                            ...
                            className={`transition-all duration-200 border-x-[2px] border-t-[2px] border-b-[1px] border-[#e4e5e6] w-6 h-6 flex items-center justify-center text-slate-600 text-sm p-1 ${
                              selectedMaterial &&
                              "hover:border-[#a0a1ab] cursor-pointer"
                            } `}
                          >
                            <i className="text-black fa-solid fa-plus text-xs"></i>
                          </div>
                          <div
                          ...
                          >
                            <i className="text-black fa-solid fa-minus text-xs"></i>
                          </div>
                        </div>
                      </div>
