...
import { IDetailedMovements } from "@/declarations";
            ...
            <div className="flex flex-col gap-3 min-w-[300px] max-w-[820px]">
              <div className="flex justify-between">
                <div className="flex flex-col gap-2 items-start">
                  ...
                  <p className="text-slate-600">{movement.productDTO.name}</p>
                </div>
                <div className="flex flex-col gap-2 items-start">
                  <p className="font-semibold text-slate-700">Categoria:</p>
                  <p className="text-slate-600">
                    {movement.productDTO.subCategory.category.name}
                  </p>
                </div>
                <div className="flex flex-col gap-2 items-start">
                  <p className="font-semibold text-slate-700">Sub Categoria:</p>
                  <p className="text-slate-600">
                    {movement.productDTO.subCategory.name}
                  </p>
                </div>
                {movement.productDTO.supplier && (
                  <div className="flex flex-col gap-2 items-start">
