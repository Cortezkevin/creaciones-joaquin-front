...
import { IOrder, IOrderTableCell, IOrderTableColumn, OrderStatus, ShippingStatus } from "@/declarations";
import { Chip, Spinner, Table, TableBody, TableCell, TableColumn, TableHeader, TableRow, Tooltip } from "@nextui-org/react";
          ...
          return (
            <div className="relative flex justify-center items-center gap-2">
              <Tooltip color="warning" content="Ver Detalles">
                <span className="text-lg text-warning cursor-pointer active:opacity-50" onClick={() => router.push("/orders/" + item.id)}>
                  <i className="fa-solid fa-eye"></i>
                </span>
              </Tooltip>
              <Tooltip color="danger" content="Anular">
